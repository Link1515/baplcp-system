...
<body>
    <div class="lg:max-w-xl lg:shadow max-w-3xl min-h-screen pt-12 mx-auto pb-[72px]">
        <header
            class="flex items-center gap-2 h-12 px-4 shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] fixed top-0 left-0 w-full bg-white">
